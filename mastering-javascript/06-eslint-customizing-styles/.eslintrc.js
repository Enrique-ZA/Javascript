module.exports = {
  ...
  "extends": [
    // "eslint:recommended", // npm require: eslint
    "airbnb-base" // npm require: eslint-config-airbnb-base
  ],
  "globals": {
    "Atomics": "readonly",
  ...
  "rules": {
    ...
    // space between keyword and ( or not
      ...
      "no-unused-vars": 'warn',
      // Give function expressions names to aid in debugging
      "func-names": ['error', 'as-needed'],
      // No comparing vars to themselves
